...
package com.tgcity.widget.spinner;
...
public class MaterialSpinner extends TextView {
    ...
    private boolean isBackgroundSelector;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        defaultPaddingLeft = defaultPaddingRight =
                defaultPaddingBottom = defaultPaddingTop = resources.getDimensionPixelSize(R.dimen.ms_padding_top);
        if (rtl) {
            defaultPaddingRight = resources.getDimensionPixelSize(R.dimen.ms_padding_left);
        } else {
            defaultPaddingLeft = resources.getDimensionPixelSize(R.dimen.ms_padding_left);
        }
        defaultPopupPaddingLeft =
                defaultPopupPaddingRight = resources.getDimensionPixelSize(R.dimen.ms_popup_padding_left);
        defaultPopupPaddingTop = defaultPopupPaddingBottom = resources.getDimensionPixelSize(R.dimen.ms_popup_padding_top);

        try {
            backgroundColor = ta.getColor(R.styleable.MaterialSpinner_ms_background_color, Color.WHITE);
            isRight = ta.getBoolean(R.styleable.MaterialSpinner_ms_is_right, false);
            isBackgroundSelector = ta.getBoolean(R.styleable.MaterialSpinner_ms_is_background_selector, true);
