...
import com.tgcity.widget.titlebar.R;
...
public class TitleBar extends Toolbar {
    ...
    private View.OnClickListener rightMenuListener;
    ...
    public TitleBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.tb_TitleBar);
        backRes = typedArray.getResourceId(R.styleable.tb_TitleBar_tb_back, 0);
        rightImgMenuRes = typedArray.getResourceId(R.styleable.tb_TitleBar_tb_rightImgRes, 0);
        rightStrColor = typedArray.getColor(R.styleable.tb_TitleBar_tb_rightStrColor, 0) == 0 ? rightStrColor : typedArray.getColor(R.styleable.tb_TitleBar_tb_rightStrColor, 0);
        titleStr = typedArray.getString(R.styleable.tb_TitleBar_tb_title);
        doubleClickTip = typedArray.getString(R.styleable.tb_TitleBar_tb_doubleClickTip) == null ? doubleClickTip : typedArray.getString(R.styleable.tb_TitleBar_tb_doubleClickTip);
        rightTextMenuStr = typedArray.getString(R.styleable.tb_TitleBar_tb_rightStr);
        doubleClickTipValves = typedArray.getInt(R.styleable.tb_TitleBar_tb_doubleClickTipValves, doubleClickTipValves);
        leftImgScaleType = typedArray.getInt(R.styleable.tb_TitleBar_tb_leftImgScaleType, leftImgScaleType);
        rightImgScaleType = typedArray.getInt(R.styleable.tb_TitleBar_tb_rightImgScaleType, rightImgScaleType);
        typedArray.recycle();
        init();
    }
    ...
    private void initListener() {
        ...
        if (rightTextMenu != null) {
            if (!StringUtils.isEmpty(rightTextMenuStr)) {
    ...
    protected void init() {
        if (!isInit) {
            isInit = true;
            LayoutInflater.from(getContext()).inflate(R.layout.tb_toolbar_layout, this);
