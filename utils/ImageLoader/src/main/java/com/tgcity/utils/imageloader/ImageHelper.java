...
public class ImageHelper {
     ...
     * 添加缓存
     */
    public static void showLruCache(ImageView imageView, @DrawableRes int loadingResId, @DrawableRes int failResId, String path, long modified) {
        getImageLoader().show(imageView, path, loadingResId, failResId, 0, 0, null, modified);
    }
