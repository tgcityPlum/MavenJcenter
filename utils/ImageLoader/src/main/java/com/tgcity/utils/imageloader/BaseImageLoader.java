...
public abstract class BaseImageLoader {
    ...
    public abstract void show(ImageView imageView, String path, @DrawableRes int loadingResId, @DrawableRes int failResId, int width, int height, DisplayDelegate delegate, long modified);
