...
import com.tgcity.function.pickerview.TimePickerView;
import com.tgcity.function.pickerview.adapter.ArrayWheelAdapter;
...
//                        tvTime.setText(getTime(date));
    ...
    public static void alertBottomWheelOption(Context context, ArrayList<?> list, final OnWheelViewClick click) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.pv_layout_bottom_wheel_option, null);
