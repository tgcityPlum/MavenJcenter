package com.tgcity.function.pickerview.lib;
...
import com.tgcity.function.pickerview.adapter.WheelAdapter;
import com.tgcity.function.pickerview.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.pv_wheelview_textcolor_out);
        textColorCenter = getResources().getColor(R.color.pv_wheelview_textcolor_center);
        dividerColor = getResources().getColor(R.color.pv_wheelview_textcolor_divider);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(R.dimen.pv_textsize);
        customTextSize = getResources().getBoolean(R.bool.pv_customTextSize);
        if(attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.pv_wheelview,0,0);
            mGravity = a.getInt(R.styleable.pv_wheelview_pv_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.pv_wheelview_pv_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.pv_wheelview_pv_textColorCenter,textColorCenter);
            dividerColor = a.getColor(R.styleable.pv_wheelview_pv_dividerColor,dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.pv_wheelview_pv_textSize,textSize);
        }
