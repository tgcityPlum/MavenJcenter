package com.tgcity.function.adapter.callback;
...
import com.tgcity.function.adapter.R;
...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG
            ...
            viewHolder.itemView.setTag(R.id.ra_BaseQuickAdapter_dragging_support, true);
        } else if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE
                && !isViewCreateByAdapter(viewHolder)) {
            mAdapter.onItemSwipeStart(viewHolder);
            viewHolder.itemView.setTag(R.id.ra_BaseQuickAdapter_swiping_support, true);
        }
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getTag(R.id.ra_BaseQuickAdapter_dragging_support) != null
                && (Boolean) viewHolder.itemView.getTag(R.id.ra_BaseQuickAdapter_dragging_support)) {
            mAdapter.onItemDragEnd(viewHolder);
            viewHolder.itemView.setTag(R.id.ra_BaseQuickAdapter_dragging_support, false);
        }
        if (viewHolder.itemView.getTag(R.id.ra_BaseQuickAdapter_swiping_support) != null
                && (Boolean) viewHolder.itemView.getTag(R.id.ra_BaseQuickAdapter_swiping_support)) {
            mAdapter.onItemSwipeClear(viewHolder);
            viewHolder.itemView.setTag(R.id.ra_BaseQuickAdapter_swiping_support, false);
        }
    }
