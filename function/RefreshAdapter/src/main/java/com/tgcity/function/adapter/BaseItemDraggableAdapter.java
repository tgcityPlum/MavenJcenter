    ...
    public void onBindViewHolder(K holder, int position) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
            ...
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                ...
                if (toggleView != null) {
                    toggleView.setTag(R.id.ra_BaseQuickAdapter_viewholder_support, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(R.id.ra_BaseQuickAdapter_viewholder_support, holder);
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.ra_BaseQuickAdapter_viewholder_support));
                    }
                    return true;
                }
            };
