...
import com.tgcity.function.adapter.animation.AlphaInAnimation;
import com.tgcity.function.adapter.animation.BaseAnimation;
import com.tgcity.function.adapter.animation.ScaleInAnimation;
import com.tgcity.function.adapter.animation.SlideInBottomAnimation;
import com.tgcity.function.adapter.animation.SlideInLeftAnimation;
import com.tgcity.function.adapter.animation.SlideInRightAnimation;
import com.tgcity.function.adapter.entity.IExpandable;
import com.tgcity.function.adapter.loadmore.LoadMoreView;
import com.tgcity.function.adapter.loadmore.SimpleLoadMoreView;
import com.tgcity.function.adapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private OnBindRecyclerViewCallBack mOnBindRecyclerViewCallBack;
    ...
    private void setRecyclerView(RecyclerView recyclerView) {
        ...
        if (mOnBindRecyclerViewCallBack != null) {
            mOnBindRecyclerViewCallBack.onBindRecyclerView(mRecyclerView);
        }
    }
    ...
    public void setNewData(@Nullable List<T> data, final RecyclerView recyclerView, final OnBindDataCompleteCallBack onBindDataCompleteCallBack) {
    ...
    /**
     * if showLruCache empty view will be return 1 or not will be return 0
     *
     * @return
     */
    ...
    public void setSetupViewType(boolean mSetupViewType) {
        this.mSetupViewType = mSetupViewType;
    }
    ...
    public void setWRAPEmptyView(View emptyView) {
        boolean insert = false;
        if (mEmptyLayout == null) {
            mEmptyLayout = new FrameLayout(emptyView.getContext());
     ...
     *
     * @param isHeadAndEmpty false will not showLruCache headView if the data is empty true will showLruCache emptyView and headView
     */
    ...
    /**
     * set emptyView showLruCache if adapter is empty and want to showLruCache headview and footview
     * Call before {@link RecyclerView#setAdapter(RecyclerView.Adapter)}
     *
     ...
     *
     * @return The view to showLruCache if the adapter is empty.
     */
    ...
    /**
     * add animation when you want to showLruCache time
     *
     * @param holder
     */
     ...
     *
     * @param firstOnly true just showLruCache anim when first loading false showLruCache anim when load the data every time
     */
...
//            subItemCount += list.size();
    ...
    /**
     * 用来在绑定RecyclerView完成后触发
     */
    public interface OnBindRecyclerViewCallBack {
     ...
     * 用来在绑定数据完成时候触发
     */
    public interface OnBindDataCompleteCallBack {
        void onBindDataComplete();
    }

    public void setOnBindRecyclerViewCallBack(OnBindRecyclerViewCallBack mOnBindRecyclerViewCallBack) {
        this.mOnBindRecyclerViewCallBack = mOnBindRecyclerViewCallBack;
    }
