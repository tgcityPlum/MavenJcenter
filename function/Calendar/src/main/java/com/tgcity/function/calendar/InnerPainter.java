        ...
        if (mAttrs.showHolidayWorkday) {
            ...
            if (mHolidayList.contains(localDate)) {
                if (holidayDrawable == null) {
                    ...
                    canvas.drawText(TextUtils.isEmpty(mAttrs.holidayText) ? mContext.getString(R.string.nc_holidayText) : mAttrs.holidayText, holidayLocation[0], getTextBaseLineY(holidayLocation[1]), mTextPaint);
                } else {
                ...
                if (workdayDrawable == null) {
                    ...
                    canvas.drawText(TextUtils.isEmpty(mAttrs.workdayText) ? mContext.getString(R.string.nc_workdayText) : mAttrs.workdayText, holidayLocation[0], getTextBaseLineY(holidayLocation[1]), mTextPaint);
                } else {
