...
import com.tgcity.function.banner.listener.OnBannerClickListener;
import com.tgcity.function.banner.listener.OnBannerListener;
import com.tgcity.function.banner.loader.ImageLoaderInterface;
import com.tgcity.function.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    public String tag = "bn_layout_view";
    ...
    private int mIndicatorSelectedResId = R.drawable.bn_gray_radius;
    private int mIndicatorUnselectedResId = R.drawable.bn_white_radius;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.bn_Banner);
        mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.bn_Banner_bn_indicator_width, indicatorSize);
        mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.bn_Banner_bn_indicator_height, indicatorSize);
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.bn_Banner_bn_indicator_margin, BannerConfig.PADDING_SIZE);
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.bn_Banner_bn_indicator_drawable_selected, R.drawable.bn_gray_radius);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.bn_Banner_bn_indicator_drawable_unselected, R.drawable.bn_white_radius);
        scaleType = typedArray.getInt(R.styleable.bn_Banner_bn_image_scale_type, scaleType);
        delayTime = typedArray.getInt(R.styleable.bn_Banner_bn_delay_time, BannerConfig.TIME);
        scrollTime = typedArray.getInt(R.styleable.bn_Banner_bn_scroll_time, BannerConfig.DURATION);
        isAutoPlay = typedArray.getBoolean(R.styleable.bn_Banner_bn_is_auto_play, BannerConfig.IS_AUTO_PLAY);
        isEnableScroll = typedArray.getBoolean(R.styleable.bn_Banner_bn_is_enable_scroll, BannerConfig.IS_ENABLE_SCROLL);
        titleBackground = typedArray.getResourceId(R.styleable.bn_Banner_bn_title_background, BannerConfig.TITLE_BACKGROUND);
        titleHeight = typedArray.getDimensionPixelSize(R.styleable.bn_Banner_bn_title_height, BannerConfig.TITLE_HEIGHT);
        titleTextColor = typedArray.getColor(R.styleable.bn_Banner_bn_title_textcolor, BannerConfig.TITLE_TEXT_COLOR);
        titleTextSize = typedArray.getDimensionPixelSize(R.styleable.bn_Banner_bn_title_textsize, BannerConfig.TITLE_TEXT_SIZE);
        typedArray.recycle();
    }

    private void initView(Context context, AttributeSet attrs) {
        imageViews.clear();
        View view = LayoutInflater.from(context).inflate(R.layout.bn_layout_view, this, true);
