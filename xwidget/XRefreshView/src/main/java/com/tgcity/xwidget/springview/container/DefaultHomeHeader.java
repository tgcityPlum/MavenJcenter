 ...
 */
public class DefaultHomeHeader extends BaseHeader {
    ...
    public DefaultHomeHeader(Context context) {
        this(context, R.drawable.xrv_progress_home_small, R.drawable.arrow_home);
    }

    @Override
    public int getDragLimitHeight(View rootView) {
        return rootView.findViewById(R.id.rl_header).getHeight();
    }

    public DefaultHomeHeader(Context context, int rotationSrc, int arrowSrc) {
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.default_home_header, viewGroup, true);
