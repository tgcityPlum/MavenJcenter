...
import com.tgcity.xwidget.titlebar.R;
...
public class TitleBar extends Toolbar {
    ...
    public TitleBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.xtb_TitleBar);
        ...
        doubleClickTipValves = typedArray.getInt(R.styleable.xtb_TitleBar_xtb_doubleClickTipValves, doubleClickTipValves);
        leftImgScaleType = typedArray.getInt(R.styleable.xtb_TitleBar_xtb_leftImgScaleType, leftImgScaleType);
        rightImgScaleType = typedArray.getInt(R.styleable.xtb_TitleBar_xtb_rightImgScaleType, rightImgScaleType);
        typedArray.recycle();
        init();
    }
    ...
    protected void init() {
        if (!isInit) {
            isInit = true;
            LayoutInflater.from(getContext()).inflate(R.layout.xtb_toolbar_layout, this);
