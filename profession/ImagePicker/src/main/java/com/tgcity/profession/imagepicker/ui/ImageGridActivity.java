...
import com.tgcity.profession.imagepicker.DataHolder;
import com.tgcity.profession.imagepicker.ImageDataSource;
import com.tgcity.profession.imagepicker.ImagePicker;
import com.tgcity.profession.imagepicker.R;
import com.tgcity.profession.imagepicker.adapter.ImageFolderAdapter;
import com.tgcity.profession.imagepicker.adapter.ImageGridAdapter;
import com.tgcity.profession.imagepicker.bean.ImageFolder;
import com.tgcity.profession.imagepicker.bean.ImageItem;
import com.tgcity.profession.imagepicker.view.FolderPopUpWindow;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_PERMISSION_STORAGE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                showToast("权限未开启，请前往\"设置-应用程序\"打开");
            }
