package com.tgcity.profession.update.utils;
...
public class UpdateUtils {
    ...
    public static String APP_UPDATE_DOWN_APK_PATH = "xietong" + File.separator + "download"+ File.separator + "apk";
    ...
    @SuppressWarnings("ResultOfMethodCallIgnored")
    public static void clearDownload(String mApkName) {
        if (mApkName != null && mApkName.length() > 0) {
            String localApkDownSavePath = getLocalApkDownSavePath(mApkName);
            deleteFile(localApkDownSavePath);
        }
     ...
     */
    public static boolean installNormal(Context context, String apkPath, String application_id) {
        if (apkPath == null) {
            return false;
        }
        try {
