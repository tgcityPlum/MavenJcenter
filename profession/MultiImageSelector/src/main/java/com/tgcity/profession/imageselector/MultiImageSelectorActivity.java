 ...
 * Updated by tgcity on 2019/12/20.
 */
public class MultiImageSelectorActivity extends AppCompatActivity
     ...
     */
    public static final String EXTRA_OPEN_STYLE = "open_style";
    ...
    public static int mDefaultCount = DEFAULT_IMAGE_SIZE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            bundle.putBoolean(MultiImageSelectorFragment.EXTRA_SHOW_CAMERA, isShow);
            bundle.putInt(MultiImageSelectorFragment.EXTRA_OPEN_STYLE, intent.getIntExtra(EXTRA_OPEN_STYLE, 2));
